...
/*
		System.out.println("Añade enteros positivos a la lista.");
		while (a >= 0) {
...
//Añado numeros por programa para las pruebas
		...
		System.out.println("La media aritmetica de la lista es: " + (aux/tamanoLista)
		+ " , donde " + tamanoLista + " es el tamaño de la lista y " + aux + " la suma de todos sus valores.");
		...
		System.out.println("El valor correspondiente al indice: " + indiceBuscar + " es: " + numeritos.get(indiceBuscar));
		
		// F. Incrementa el valor en ultima posicion en 1.
		System.out.println("La ultima posicion de la lista es la num. " + numeritos.size() 
			+ " con valor: " + numeritos.get(numeritos.size()-1));
		...
		System.out.println("Valor de la posicion: " + numeritos.size() + " es ahora de: " 
		...
		// K. Creamos otra lista con la misma cantidad de numeros aleatorios entre 5 y 100 y comparamos.
