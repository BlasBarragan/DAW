 ...
 * DAWS 2022-2023
 * 
 * Práctica evaluable 2: Ejercicios 1-4
 * 
 * Autor: José Ramón Simó (Profesor)
 * 
 * Nota: la solución de los ejercicios se ha hecho desde el punto de vista más descriptivo, sacrificando
 *           optimización. Es por ello que también se ha obviado la comprobación de errores en la introducción
 *           de los datos de usuario, con el objetivo de plasmar un código más limpio para el alumnado.
 */

import java.util.Scanner;

public class Ejercicio_SOLUCION {
	/*
	...
	public static void imprimirBillete(String nombreCliente, char tipoDestino, int nNoches, float precioBase, float precioTotal, float totalSobrecargos, char tipoPago, int diaInicioViaje) {
		...
		// Muestro total de sobrecargos
		System.out.println("\tTotal sobrecargos: " + totalSobrecargos + "€" );
		
		/*
		 *  Muestro el total con los decuentos (Ejercicio 4)
		 */
		System.out.println("\n**TOTAL**");
	...
	public static void main(String[] args) {
		...
		int opcion = 0; // La opción del menú de usuario
		
		/*
		 * El código sigue el esquema del algoritmo del Ejercicio 1
		 */
		
		// Declaro las variables facturación y numReservas
		float facturacion = 0;
		int numReservas = 0;
		...
		do {
			...
			opcion = sc.nextInt();
			sc.nextLine(); // Consumo retorno de carro para no tener problemas posteriormente
			
			/*
 			 * El bloque de código del case 1 podría ponerse en una función aparte, pero por claridad
 			 * y fidelidad con el enunciado de la pregunta lo dejo en la función principal.
 			 */
			switch(opcion) {
		 		case 1:
		 			// Leer (nombre, tipo_dest, noches)
		 			// Leo los datos de cliente: nombre, tipo destino, número de noches, etc.
		 			System.out.println("\n=================Añadir Cliente=================");
		 			
		 			System.out.print("Nombre: ");
		 			String nombreCliente = sc.nextLine();
		 			
		 			// Pido la edad del cliente (Ejercicio 4)
		 			System.out.print("Edad: ");
		 			int edad = sc.nextInt();

		 			// Esto se puede hacer con tipo int, String o char, por ejemplo
		 			...
		 			// Ejercicio 2: calcular sobrecargo por tipo de pago
		 			System.out.print("Tipo de pago (C: T.Crédito, E: Efectivo, T: Transferencia): ");
		 			char tipoPago = sc.next().charAt(0);
		 			
		 			// Ejercicio 3: calcular sobrecargo por días del mes
		 			System.out.print("Día inicio de viaje (1-31): ");
		 			int diaInicioViaje = sc.nextInt();
		 			System.out.println("===============Fin Añadir Cliente================");
		 			
		 			/*
		 			 * Calculo el precio del billete (Ejercicio 1)
		 			 *  Llamo a la función calcularPrecioBillete
		 			 */
		 			float precioBase = calcularPrecioBillete(tipoDestino, nDias);
		 			
		 			/* 
		 			 * Calculo el sobrecargo por tipo de pago (Ejercicio 2)
		 			 * Llamo a la función calcularSobrecargoTipoPago
		 			 */
		 			float sobrecargoPago = calcularSobrecargoTipoPago(tipoPago);
		 			
		 			/* 
		 			 * Calculo el sobrecargo según día de salida  (Ejercicio 3)
		 			 * Llamo a la función calcularSobrecargoDiaInicioViaje
		 			 */
		 			float sobrecargoDiaInicioViaje = calcularSobrecargoDiaInicioViaje(diaInicioViaje);
		 			
		 			// Actualizo el precio con sobrecargos
		 			float totalSobrecargos = sobrecargoPago + sobrecargoDiaInicioViaje;
		 			
		 			// Actualizo el precio total sobre el precio base con sobrecargos
		 			float precioTotal = precioBase + totalSobrecargos;
		 			
		 			/* 
		 			 * Calculo los desceuntos según edad y número de días de viaje  (Ejercicio 4)
		 			 * Llamo a la función calcularDescuento
		 			 */
		 			...
		 			// Actualizo la facturación
		 			facturacion += precioTotal;

		 			// Actualizo el número de reservas realizadas
		 			numReservas++;
		 			break;
		 		case 2:
		 		case 3:
