/*
 * Barragán Román, Blas
 * Practica Evaluable 03 Hundir la flota
 * 
...
public class PracticaHLF {
	...
	/**
     * Funcion main
     * Inicializa el juego y una vez comienza se compara el numero de intentos 
     * para determinar si continua la partida o la perdemos al llegar a 0. 
     * 
     */
    ...
    static char[][] inicializarTableroPersonalizado(int filas, int columnas, int numIntentos, int numBarcos) {
        ...
        // Colocamos barcos aleatorios según el número especificado
        for (int k = 0; k < numBarcos; k++) {
            Random rd = new Random();
            int tamano = rd.nextInt(3) + 1; // Tamaño aleatorio entre 1 y 3

            // Comprobamos que los barcos no se solapen 
     ...
     * Añade los barcos al tablero de forma aleatoria.
     */
    ...
    /**
     * Funcion disparo
     * Muestra los intentos disponibles y 
     * consulta al jugador la coordenada para realizar el disparo. 
     * Despues gestiona la coordenada y actualiza el tablero con el resultado.
     */
