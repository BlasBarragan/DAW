...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Scanner sc = new Scanner(System.in); int a = 0;
		 * System.out.println("Añade enteros positivos a la pila."); while (a >= 0) { //
		 * Usamos la estructura del ejercicio1 donde al introducir -1 indicamos que
		 * hemos acabado de añadir numeros
		...
		// C. Imprimir la pila en vertical en formato logico (primero abajo, ultimo
		// arriba).
		...
		for (int i = pila.size() - 1; i >= 0; i--) { // Obtenemos el tamaño de la pila y le restamos 1 (indice empieza
														// en 0)
			System.out.println("Indice: " + pila.indexOf(pila.get(i)) + " Valor: " + pila.get(i) + " Posicion: "
