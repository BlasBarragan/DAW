...
function mostrarContenido() {
  ...
  if (peticio_http.readyState == 4) {
    if (peticio_http.status == 200) {  //si tot OK
      ...
      // Añadir que al recibir datos de BD, cada 4 comentarios agrege un <a> entre anterior y siguiente. Y que tanto anterior como siguiente, modifiquen ini con +-4.
...
function leerDatos(indice) {
  ...
  peticio_http.open('GET', 'arxiu.php?video=1&ini=' + indice, true);
